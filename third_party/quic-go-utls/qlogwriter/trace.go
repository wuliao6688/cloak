...
import (
	...
	"github.com/wuliao6688/quic-go-utls/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/wuliao6688/quic-go-utls/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/wuliao6688/quic-go-utls" {
