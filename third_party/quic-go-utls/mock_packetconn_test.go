...
//
//	mockgen -typed -package quic -self_package github.com/wuliao6688/quic-go-utls -self_package github.com/wuliao6688/quic-go-utls -destination mock_packetconn_test.go net PacketConn
//
